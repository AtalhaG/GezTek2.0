      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // Ayarlar Listesi
            _buildSettingsSection(l10n.appearance, [
              _buildSettingsTile(
              ...
              _buildSettingsTile(
                ...
                trailing: DropdownButton<String>(
                  ...
                  items:
                      LanguageProvider.languageOptions.entries.map((entry) {
            ...
            _buildSettingsSection(l10n.notifications, [
              _buildSettingsTile(
            ...
            _buildSettingsSection(l10n.account, [
              _buildSettingsTile(
            ...
            _buildSettingsSection(l10n.app, [
              _buildSettingsTile(
